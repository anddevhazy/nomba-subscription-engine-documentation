...
export default function QuickStart() {
  return (
    <>
      ...
      <CardGrid cols={1}>
        <Card icon="📝" title="Create a plan and subscribe a test customer">
          <p>
  ...
  -d '{
    ...
    "paymentMethod": "tok_test_visa_4242"
      ...
      <CardGrid cols={1}>
        <Card icon="🔁" title="Break a payment on purpose and watch recovery fire">
          <p>
  ...
  -H "Authorization: Bearer nse_sandbox_..."`}
      ...
      <CardGrid cols={1}>
        <Card icon="🔔" title="Subscribe a webhook and pull analytics">
          <p>
