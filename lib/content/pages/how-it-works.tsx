...
`}
      ...
      <p>
        ...
        a Nomba Checkout session. The customer completes card entry inside that
        session, the raw card number never touches Lumen&apos;s servers or the
        Subscription Engine&apos;s. Nomba tokenises the card and returns a
      ...
      <p>
        The billing engine calls Nomba&apos;s Charge API with the stored token.
      ...
      <p>
        ...
        what decides the outcome, Nomba&apos;s own webhook confirms it a moment
