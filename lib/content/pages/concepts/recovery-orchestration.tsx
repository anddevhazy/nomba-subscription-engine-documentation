  ...
  return (
    <>
      ...
      <Steps>
        ...
        <Step number={5} title="A retry, pause, or cancel link redeems the outcome">
          <p>
            WhatsApp and USSD interactions resolve through these links today. Wiring the same links into the
            outbound email body and an inbound SMS reply is the gap between where this is now and the fully
            channel-agnostic version described in the product vision.
          </p>
        </Step>
      </Steps>
