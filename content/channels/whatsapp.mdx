...
<div className="card-grid cols-2">
  <a className="card" href="/channels/sms"><div className="card-icon">✉️</div><div className="card-title">SMS</div><div className="card-desc">The fallback channel, and where it's the primary one instead.</div></a>
