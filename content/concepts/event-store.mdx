...
<div className="card-grid cols-3">
  ...
  <div className="card"><div className="card-icon">📣</div><div className="card-title">Notifications</div><div className="card-desc">Email, WhatsApp, SMS, and USSD recovery messages are triggered by the same events, read by the recovery-orchestration component.</div></div>
