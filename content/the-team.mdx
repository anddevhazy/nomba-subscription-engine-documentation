...
<div className="card-grid cols-2">
  ...
  <div className="card"><div className="card-icon">🔁</div><div className="card-title">Recovery & notifications engineer</div><div className="card-desc">Owns dunning: the retry schedule, the grace period, and the WhatsApp/SMS/USSD orchestration that decides who gets contacted, how, and when.</div></div>
